...
def world_health_news():
    r = requests.get(
        'http://newsapi.org/v2/top-headlines?country=us&category=health&apiKey=db0dbc6d89ae4a8583fb8c71a49deb8b').json()
...
def nigeria_news():
    data = requests.get(
        'http://newsapi.org/v2/top-headlines?country=ng&category=health&apiKey=db0dbc6d89ae4a8583fb8c71a49deb8b').json()
...
def sa_news():
    data = requests.get(
        'http://newsapi.org/v2/top-headlines?country=za&category=health&apiKey=db0dbc6d89ae4a8583fb8c71a49deb8b').json()
...
def covid_stats():
    ...
    south_live = requests.get(
        'https://api.covid19api.com/total/country/south-africa').json()
    uganda_live = requests.get(
        'https://api.covid19api.com/total/country/uganda').json()
    nigeria_live = requests.get(
        'https://api.covid19api.com/total/country/nigeria').json()
